        ...
        <div className="wsWrap">
          <div className="wsWrap_disc">
            ...
            <p className="wsWrap_disc__text">
              We offer loose tea leaves of the best quality for your business. With a choice of more
              than 450 different kinds of loose tea, we can make a sophisticated selection that fits
              exactly in your kind of establishment.
            </p>
