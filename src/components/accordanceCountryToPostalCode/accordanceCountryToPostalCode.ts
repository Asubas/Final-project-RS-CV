...
function AccordanceCountryToPostalCode() {
  ...
  if(currentContainerClassName !== null){
    ...
    const currentElementContainer = document.querySelector('.' + currentContainerClassName) as HTMLElement;
    const currentElementPostalCodeInput = currentElementContainer.children[3].children[0] as HTMLInputElement;
