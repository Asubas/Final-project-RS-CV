...
interface CustomerDraftsWithoutDefaultAddress {
  email: string;
  firstName: string;
  lastName: string;
  password: string;
...
async function registerUserWithoutDefaultAddresses() {
  ...
  const regCustomerInformation: CustomerDraftsWithoutDefaultAddress = {
...
export default registerUserWithoutDefaultAddresses;
